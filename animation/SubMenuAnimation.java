...
public class SubMenuAnimation<T> implements Menu<T> {
    ...
    /**
     * Instantiates a new Sub menu animation.
     *
     * @param title      the sub menu title.
     * @param keyboard   the keyboard.
     * @param background the sub menu background.
     */
    public SubMenuAnimation(String title, KeyboardSensor keyboard, Image background) {
